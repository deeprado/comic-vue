<template>
  <div class="detail">
    <head-top
      :title-name="comicDetailTop.title"
      :show-back-icon="true"
    ></head-top>
    <div class="detail-top">
      ...
      <div class="detail-top-right">
        <div class="top-header">
          ...
          <span class="span-score"> {{ comicDetailTop.score }}</span>
        </div>
...
import HomeComicDetailData from '../../mock/home_comic_overview.json'
...
export default {
  ...
  created () {
    this.http
      ...
      .catch(error => {
        this.comicDetailTop = HomeComicDetailData.data
        console.log(error)
        setTimeout(() => {
          this.showLoading = false
        }, 800)

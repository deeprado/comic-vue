...
import HomeUserItemsData from '../../mock/home_user_items.json'

export default {
  data () {
    return {
      avatar:
        'https://tianyue.oss-cn-hangzhou.aliyuncs.com/comic-user-center/sky.jpeg',
      itemList: [],
      currentY: 0,
      showLoading: true
    }
  ...
  created () {
    this.http
      ...
      .catch(error => {
        this.itemList = HomeUserItemsData.data.items
        console.log(error)
        setTimeout(() => {
          this.showLoading = false
        }, 400)
